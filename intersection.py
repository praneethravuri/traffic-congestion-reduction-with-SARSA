...
carsCrossed = {'west': 0, 'south': 0, 'east': 0, 'north': 0}


# Coordinates of vehicles' start
x = {'west':[0,0,0], 'south':[755,727,697], 'east':[1400,1400,1400], 'north':[602,627,657]}    
y = {'west':[348,370,398], 'south':[0,0,0], 'east':[498,466,436], 'north':[800,800,800]}

vehicles = {'west': {0:[], 1:[], 2:[], 'crossed':0}, 'south': {0:[], 1:[], 2:[], 'crossed':0}, 'east': {0:[], 1:[], 2:[], 'crossed':0}, 'north': {0:[], 1:[], 2:[], 'crossed':0}}
vehicleTypes = {0:'car', 1:'bus', 2:'truck', 3:'bike'}
directionNumbers = {0:'west', 1:'south', 2:'east', 3:'north'}
...
stopLines = {'west': 590, 'south': 330, 'east': 800, 'north': 535}
defaultStop = {'west': 580, 'south': 320, 'east': 810, 'north': 545}
# stops = {'west': [580,580,580], 'south': [320,320,320], 'east': [810,810,810], 'north': [545,545,545]}
